...
BEGIN_MESSAGE_MAP(CIPCClient1App, CWinApp)
...
// 唯一一個 CIPCClient1App 物件

CIPCClient1App theApp;


// CIPCClient1App 初始化

BOOL CIPCClient1App::InitInstance()
{
