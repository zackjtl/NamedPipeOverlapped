...
BEGIN_MESSAGE_MAP(CIPCServer2App, CWinApp)
...
// 唯一一個 CIPCServer2App 物件

CIPCServer2App theApp;


// CIPCServer2App 初始化

BOOL CIPCServer2App::InitInstance()
{
