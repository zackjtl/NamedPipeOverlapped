...
//---------------------------------------------------------------------------
string IntToString(int Value, UINT FieldWidth)
{
  ostringstream  text;
...
//---------------------------------------------------------------------------
wstring IntegerStrToWStr(int Value, UINT FieldWidth)
{
  wostringstream  text;
...
//---------------------------------------------------------------------------
wstring IntegerStrToWStr(int Value)
{
	//wchar_t   temp[33];
...
//---------------------------------------------------------------------------
string Int64ToString(UINT64 Value)
{
  ostringstream  text;
...
//---------------------------------------------------------------------------
wstring Integer64StrToWStr(UINT64 Value)
{
  wostringstream  text;
...
{
  if (Ms < 10000) {
    return IntegerStrToWStr(Ms) + L" ms";
  }
  else {
    UINT sec = Ms / 1000;
    return IntegerStrToWStr(sec) + L" sec";
  }
  return L"";
}
//---------------------------------------------------------------------------
